...
print_header "Compiling Backend"
spinner "JAVA_HOME=\"$JAVA_HOME\" mvn clean compile" "Compiling backend..."
...
spinner "JAVA_HOME=\"$JAVA_HOME\" mvn clean install -DskipTests" "Installing backend..."
...
print_header "Compiling Frontend"
spinner "JAVA_HOME=\"$JAVA_HOME\" mvn clean compile" "Compiling frontend..."
...
echo -e "${BOLD}Backend module:${NC} Installed and verified"
echo -e "${BOLD}Frontend module:${NC} Packaged and verified"
